    ...
    <div className="min-h-screen flex flex-col">
      <section className="relative flex-1 overflow-hidden bg-gradient-to-br from-red-50 via-white to-green-50">
        <div className="absolute inset-0" aria-hidden="true">
          ...
          <div
            className="absolute bottom-32 right-16 w-32 h-32 bg-accent rounded-full opacity-10 animate-pulse"
            style={{ animationDelay: '1s' }}
          ></div>
          <div
            className="absolute top-1/2 left-1/4 w-16 h-16 bg-primary rounded-full opacity-15 animate-pulse"
            style={{ animationDelay: '2s' }}
          ></div>
          <div
            className="absolute top-1/3 right-1/3 w-24 h-24 bg-secondary rounded-full opacity-10 animate-pulse"
            ...
            <div className="glass-card relative overflow-hidden slide-up" style={{ animationDelay: '0.2s' }}>
              <div className="bg-accent p-8 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-red-100 opacity-90">Fill in your details to join our lifesaving mission</p>
                </div>
              </div>
