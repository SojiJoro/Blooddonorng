              ...
              <div className="p-8">
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="w-6 h-6 bg-accent rounded-full flex items-center justify-center mx-auto mb-1 shadow-md group-hover:shadow-lg transition-shadow">
                        <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                        </svg>
                      </div>
                    ...
                    <div className="text-center group">
                    <div className="w-6 h-6 bg-primary rounded-full flex items-center justify-center mx-auto mb-1 shadow-md group-hover:shadow-lg transition-shadow">
                        <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                    <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                      </div>
                    ...
                    <div className="text-center group">
                    <div className="w-6 h-6 bg-secondary rounded-full flex items-center justify-center mx-auto mb-1 shadow-md group-hover:shadow-lg transition-shadow">
                        <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                        </svg>
                      </div>
