                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="form-group">
                      <label htmlFor="name" className="form-label">
                        <svg className="w-3.5 h-3.5 mr-1.5 inline" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/contact" className="btn btn-outline btn-md">
                  <svg className="w-3.5 h-3.5 mr-2 inline" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.89 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                  </svg>
                  Contact Us
                </a>
            ...
            <div className="mt-8">
              <div className="flex flex-wrap justify-center gap-6 text-sm text-light">
                <span className="flex items-center">
                  <svg className="w-3.5 h-3.5 mr-1.5 text-primary" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
